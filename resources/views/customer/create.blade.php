    ...
    <div class="container">
        ...
        <div>
            ...
            @csrf
                ...
                <input type="text" name="company_name" placeholder="Customer name" id="customer_name">
                ...
                <input type="email" name="email" placeholder="Customer email" id="email">
                <label for="phone">Phone</label>
                <input type="text" name="phone" placeholder="Customer phone" id="phone">
